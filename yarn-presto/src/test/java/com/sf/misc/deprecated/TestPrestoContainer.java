...
import com.sf.misc.presto.SessionBuilder;
...
public class TestPrestoContainer {
    ...
    public void test() throws Exception {
        ...
        //YarnApplication application = null;//airlift.getInstance(Key.get(YarnApplication.class));
        YarnRMProtocol client = airlift.getInstance(Key.get(YarnRMProtocol.class, ForOnYarn.class));
        ApplicationReport report = null;//client.getApplicationReport(GetApplicationReportRequest.newInstance(Futures.getUnchecked(application.getApplication()))).getApplicationReport();
